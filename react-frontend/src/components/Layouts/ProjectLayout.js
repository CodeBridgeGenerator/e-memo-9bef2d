...
import MemorandumPage from "../MemorandumPage/MemorandumPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("department");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "department",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "department" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "department",
                      "text-black": props?.currentActiveTab2 !== "department",
                    })}
                  >
                  Department
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "department",
                      "text-yellow-700": props?.currentActiveTab2 !== "department",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("memorandum");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "memorandum",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "memorandum" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "memorandum",
                      "text-black": props?.currentActiveTab2 !== "memorandum",
                    })}
                  >
                  Memorandum
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "memorandum",
                      "text-yellow-700": props?.currentActiveTab2 !== "memorandum",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
