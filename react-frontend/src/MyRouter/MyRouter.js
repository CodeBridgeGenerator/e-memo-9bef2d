...
import SingleDepartmentPage from "../components/DepartmentPage/SingleDepartmentPage";
import DepartmentProjectLayoutPage from "../components/DepartmentPage/DepartmentProjectLayoutPage";
import SingleMemorandumPage from "../components/MemorandumPage/SingleMemorandumPage";
import MemorandumProjectLayoutPage from "../components/MemorandumPage/MemorandumProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/department/:singleDepartmentId" exact element={<SingleDepartmentPage />} />
<Route path="/department" exact element={<DepartmentProjectLayoutPage />} />
<Route path="/memorandum/:singleMemorandumId" exact element={<SingleMemorandumPage />} />
<Route path="/memorandum" exact element={<MemorandumProjectLayoutPage />} />
